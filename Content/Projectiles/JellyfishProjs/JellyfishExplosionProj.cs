    ...
    public class JellyfishExplosionProj : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            if (Projectile.ai[0] <= 60)
            {
                ...
                spriteBatch.Draw(TextureAssets.Projectile[Type].Value, Projectile.Center - Main.screenPosition, null, color, 0, Projectile.Size / 2f, bubbleScale, SpriteEffects.None, 0);
            }

            float explosionScale = ExtendedUtils.GetSquareLerp(55, 58, 70, Projectile.ai[0]) * 1.5f;
            ExtendedUtils.DrawStreak(glowBall, SpriteEffects.None, Projectile.Center - Main.screenPosition, explosionScale, 2f, 2f, 0f, ExtendedColor.JellyOrange, Color.LightGoldenrodYellow);
